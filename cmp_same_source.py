...
cmp_file_path = 'Test_Data/Real_Beginning/gravity_removal_api/Drawing_Data/2020-02-10_5_smartphone_sample.csv'
...
plt.plot(data_phone['x_velocity'], data_phone['y_velocity'])
#plt.figure()
...
watch_acc_greycode_2bit = grey_code_extraction_2bit(data_cmp['x_velocity'], data_cmp['y_velocity'])
